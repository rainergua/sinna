    ...
    await con
        ...
        .then((result) =>{
            ...
            res.status(200).json({
                ...
                mensaje:"Se obtuvo el listado de indicadores correctamente",
                cod:200
            })}
        )
...
const gestionIndicadores = async (req, res) => {
    req.body.ci_usuario = req.user.ci;
    const v_json = req.body
    const query = {
        text: `call sinna_modipi.p_gestion_indicador_lineamiento($1) `,
        values:[v_json]
    };
    await con
        .query(query)
