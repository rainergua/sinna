...
const options = {
    ...
    apis: [
            ...
            `${path.join(__dirname, "../routes/mid_autorizaciones_viaje.routes.js")}`,
            `${path.join(__dirname, "../routes/mid_autorizaciones_trabajo.routes.js")}`,
            `${path.join(__dirname, "../routes/mid_casos.routes.js")}`,
            `${path.join(__dirname, "../routes/mid_expedientes_caso.routes.js")}`,
            `${path.join(__dirname, "../routes/mid_flujos.routes.js")}`,
